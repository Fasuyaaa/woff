...
class IO(object):
    ...
    def ok(text, end='\n'):
        ...
        """
        IO.print('{}READY{}   {}'.format(IO.Style.BRIGHT + IO.Fore.LIGHTGREEN_EX, IO.Style.RESET_ALL, text), end=end)
    ...
    def error(text):
        ...
        """
        IO.print('{}ERROR{}  {}'.format(IO.Style.BRIGHT + IO.Fore.LIGHTRED_EX, IO.Style.RESET_ALL, text))
