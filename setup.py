...
def get_init_content():
    with open(os.path.join(os.path.dirname(os.path.abspath(__file__)), 'woff', '__init__.py'), 'r') as f:
        return f.read()
...
NAME = 'woff'
AUTHOR = 'fasuyaaa'
AUTHOR_EMAIL = 'dhavinf.a@gmail.com'
VERSION = get_version()
URL = 'https://github.com/fasuyaaa/woff'
DESCRIPTION = get_description()
KEYWORDS = ["woff", "wifi", "bandwidth", "network"]
...
CLASSIFIERS = ['Development Status :: 3 - Alpha',
               ...
               'Natural Language :: Indonesian - English',
...
PYTHON_REQUIRES = '>= 3'
ENTRY_POINTS = { 'console_scripts': ['woff = woff.woff:run'] }
